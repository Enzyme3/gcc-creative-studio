...
# --- Fetch Project Numeric Number for IAP Service Agent ---
data "google_project" "project" {
  project_id = var.gcp_project_id
}

# --- Allow IAP Service Agent to Invoke Frontend ---
...
# --- Grant HTTPS Resource Accessor to Domain via IAP ---
resource "google_iap_web_cloud_run_service_iam_member" "iap_access" {
  ...
  member                 = "domain:${var.iap_accessor_domain}"
}
